...
from .models import Level, Classroom, Class
...
def create_class(name, level_id, main_teacher_id=None, is_valid=True):
    """
    ...
    Args:
        ...
        main_teacher_id (int, optional): L'ID du professeur principal. Par défaut, None.
    ...
    try:
        ...
        main_teacher = None
        if main_teacher_id:
            main_teacher = Staff.objects.get(id=main_teacher_id)
...
def update_class(class_id, **kwargs):
    ...
    try:
        ...
        if 'main_teacher_id' in kwargs:
            main_teacher_id = kwargs.pop('main_teacher_id')
            if main_teacher_id:
                class_obj.main_teacher = Staff.objects.get(id=main_teacher_id)
            else:
